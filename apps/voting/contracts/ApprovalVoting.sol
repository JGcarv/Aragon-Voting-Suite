...
//
// //import "../../../shared/minime/contracts/MiniMeToken.sol";
...
//     event CastVote(uint256 indexed voteId, address indexed voter, bool agrees, uint256 stake);
...
//         return _newVote(_executionHashes, _metadata, true, true);
//     }
//
//     /**
//     * @notice Create a new vote about "`_metadata`"
...
//     // }
//
//     function _newVote(bytes32[] _executionScriptHashes, string _metadata, bool _castVote, bool _executesIfDecided)
//         internal
//         returns (uint256 voteId)
//     {
...
//         vote_.executionScript[] = _executionScriptHashes;
//
...
//         require(token.balanceOfAt(_voter, vote_.snapshotBlock));
//         bool[] state = vote_.voters[_voter];
//
//
